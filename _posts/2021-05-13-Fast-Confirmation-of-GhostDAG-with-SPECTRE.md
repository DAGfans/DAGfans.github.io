...
$$ gap (b,G) := \{c : c ≺_G b, c \in anticone(b) \} $$
...
![image-20210513221257866](/Users/Outlier/Library/Application Support/typora-user-images/image-20210513221257866.png)
...
![image-20210513221531983](/Users/Outlier/Library/Application Support/typora-user-images/image-20210513221531983.png)
...
$$pumping\_idx(b,G) := min \{ j : gap(b, ⟨b,G, j⟩) = 0\}$$
